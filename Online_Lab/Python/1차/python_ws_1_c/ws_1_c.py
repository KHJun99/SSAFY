...
# 아래에 코드를 작성하시오.
first_chr = password[28 : 35]
second_word = password[113 : 118]
third_word = password[66 : 69][::-1]
fourth_word = password[322 : 326][::-1]
start_idx = password[365:].find('python')
if start_idx != -1:
    fifth_word = password[365 + start_idx : 365 + start_idx + len('python')]
else:
    fifth_word = ''

print(f'{first_chr} {second_word} {third_word} {fourth_word} "{fifth_word}"')